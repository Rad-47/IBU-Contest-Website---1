...
const phases = [
  {
    ...
    body: 'Set up your profile, add a photo, set sport preferences. Learn the layout — Community feed, Live tab, Game Scores, Insider Buzz, Discover menu. Follow OHL players and other fans to build a personalised feed. Earn points just for signing up and following.',
  ...
  },
  {
    ...
    body: 'Post reels, images, and text. Like, comment, and share other fans\' and players\' content. Join player-hosted live sessions and Q&As in real time. Build daily visit streaks — consistency is rewarded on FanLinc just like in any real job. Every action earns loyalty points and raises your activity score.',
